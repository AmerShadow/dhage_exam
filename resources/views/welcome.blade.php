                ...
                <div class="row text-right   ">
                    <div class="col-md-2 m-0 p-0">
                        <a href="http://" class="btn btn-custom btn-md btn-outline-danger shadow-none"
                            rel="noopener noreferrer">Save</a>
                    </div>
                    <div class="col-md-3 m-0 p-0">
                        <a href="http://" class="btn btn-custom btn-md btn-success shadow-none"
                            rel="noopener noreferrer">Save & Next</a>
                    ...
                    <div class="card-body m-0 p-0">
                        ...
                        <div class="px-3">
                            <ul class="list-inline" id="questions_panel_widget">
                                ...
                                <li class="list-inline-item">
                                    <a class="btn-floating btn-white d-flex align-items-center  black-text "><span
                                            class="black-text">4</span></a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="btn-floating btn-white d-flex align-items-center  black-text "><span
                                            class="black-text">5</span></a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="btn-floating btn-white d-flex align-items-center   "><span
                                            class="black-text">6</span></a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="btn-floating btn-success d-flex align-items-center border-none white-text "><span
                                            class="">7</span></a>
